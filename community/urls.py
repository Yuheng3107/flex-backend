...
urlpatterns = [
    ...
    path('community/update/banner/<int:pk>', CommunityUpdateBannerView.as_view(), name='update_community_banner'),
    path('community/update/community_photo/<int:pk>', CommunityUpdatePhotoView.as_view(), name='update_community_photo'),
